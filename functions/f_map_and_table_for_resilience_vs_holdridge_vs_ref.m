function table_out = f_map_and_table_for_resilience_vs_holdridge_vs_ref(...
    ...
    if map_yes == true
        ...
        % save figure
        filename = strcat('results_review\hold_res_map_',ref_src,'_',hold_src,'_',clim_scen,'.png')
    ...
    if colorbar_yes == true
        ...
        % save figure
        filename = strcat('results_review\hold_res_colorbar_',ref_src,'_',hold_src,'_',clim_scen,'.png')
