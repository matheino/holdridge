function f_plot_baseline(dir, var_info)
%% categories:
    ...
    elseif strcmp(var_info,'dir_rcp85')
        ...
        % visualize the data
        data = log10(f_import_ref_data(dir, var_info));
    end
    ...
    elseif strcmp(var_info,'dir_rcp26') | strcmp(var_info,'dir_rcp85')
        cmap = crameri('-roma',3);
        clim = [1,3]
    end
    ...
    colormap(cmap)
    filename = strcat('results_review\',var_info,'_plot_basis_map.png')
    ...
    filename_cb = strcat('results_review\',var_info,'_colorbar_plot_basis.eps')
    print(gcf,filename_cb,'-depsc2','-r300');
    close all
